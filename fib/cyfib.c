...
static PyObject *__pyx_pf_5cyfib_cyfib(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_5cyfib_1cyfib(PyObject *__pyx_self, PyObject *__pyx_arg_n); /*proto*/
static PyMethodDef __pyx_mdef_5cyfib_1cyfib = {"cyfib", (PyCFunction)__pyx_pw_5cyfib_1cyfib, METH_O, 0};
static PyObject *__pyx_pw_5cyfib_1cyfib(PyObject *__pyx_self, PyObject *__pyx_arg_n) {
  int __pyx_v_n;
  PyObject *__pyx_r = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cyfib.cyfib", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5cyfib_cyfib(__pyx_self, ((int)__pyx_v_n));
...
static PyObject *__pyx_pf_5cyfib_cyfib(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  double __pyx_v_a;
  double __pyx_v_b;
 ...
 *         double a = 1.0
 */
  __pyx_tuple_ = PyTuple_Pack(5, __pyx_n_s_n, __pyx_n_s_n, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_i); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cyfib_pyx, __pyx_n_s_cyfib, 2, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cyfib")) {
      if (unlikely(PyDict_SetItemString(modules, "cyfib", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         double a = 1.0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5cyfib_1cyfib, NULL, __pyx_n_s_cyfib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cyfib, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
